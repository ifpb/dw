...
![](/dw/imgs/expressjs/monitor-app-prismajs-relation/monitor-db-relations-logical-model.png)

Modelo Físico

![](/dw/imgs/expressjs/monitor-app-prismajs-relation/monitor-db-relations-physical-model.png)
...
![](/dw/imgs/expressjs/monitor-app-prismajs-relation/erd.svg)
...
![](/dw/imgs/expressjs/monitor-app-prismajs-relation/monitor-app.png)
