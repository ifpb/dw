...
[Código Fonte](https://github.com/ifpb/dw/tree/main/public/codes/api/rest/) (Requisição | [REST Client](https://marketplace.visualstudio.com/items?itemName=humao.rest-client)):
...
[Código Fonte (Requisição | Rest Client)](https://github.com/ifpb/dw/tree/main/public/codes/api/rest/)
...
![](/dw/imgs/api/rest/github-post-repository.png)
...
![](/dw/imgs/api/rest/github-get-repositories.png)
...
![](/dw/imgs/api/rest/github-get-repository.png)
...
$ curl -L \
   ...
   -H "Authorization: Bearer ${TOKEN}" \
   -H "X-GitHub-Api-Version: 2022-11-28" \
   https://api.github.com/repos/lucachaves/github-repo-api
```

### Update a repository

![](/dw/imgs/api/rest/github-patch-repository.png)
...
![](/dw/imgs/api/rest/github-delete-repository.png)
