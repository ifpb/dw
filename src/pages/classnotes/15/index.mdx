...
![](/imgs/db-relationship/mvc.png)

### Entidades do Banco

![](/imgs/db-relationship/database.png)
...
<Code src="/codes/db-relationship/foods-app-sqlite-simple/src/migrations/index.js" lang="js" />

### Seeders

src/seeders/data.json:
on
<Code src="/codes/db-relationship/foods-app-sqlite-simple/src/seeders/data.json" lang="js" />

src/seeders/index.js:

<Code src="/codes/db-relationship/foods-app-sqlite-simple/src/seeders/index.js" lang="js" />

### Model

src/models/Food.js:

<Code src="/codes/db-relationship/foods-app-sqlite-simple/src/models/Food.js" lang="js" />

src/models/Category.js:

<Code src="/codes/db-relationship/foods-app-sqlite-simple/src/models/Category.js" lang="js" />
...
<img src="/imgs/db-relationship/preview.png" alt="Preview" width="100%" />
...
<img src="/imgs/db-relationship/preview.gif" alt="Preview" width="100%" />
...
![](/imgs/db-relationship/delete-food.png)

src/routes/index.js:

<Code src="/codes/db-relationship/foods-app-sqlite-delete/src/routes/index.js" lang="js" />
...
![](/imgs/db-relationship/delete-food-modal.png)
