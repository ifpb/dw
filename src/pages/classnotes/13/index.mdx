...
![](/imgs/mvc/client-server.png)

## Local da Renderização

| Client Side Rendering (CSR) | Server Side Rendering (SSR) |
| --------------------------- | --------------------------- |
| ![](/imgs/mvc/csr.png)      | ![](/imgs/mvc/ssr.png)      |
...
<Code src="/codes/mvc/foods-app-simple/src/index.js" lang="js" />
...
<Code src="/codes/mvc/foods-app-simple/src/seeders/index.js" lang="js" />

### Model

src/models/Food.js:

<Code src="/codes/mvc/foods-app-simple/src/models/Food.js" lang="js" />

### Router

src/routes/index.js:

<Code src="/codes/mvc/foods-app-simple/src/routes/index.js" lang="js" />
...
<Code
  src="/codes/mvc/foods-app-simple/src/controllers/foodsController.js"
  lang="js"
/>

### View

![](/imgs/mvc/template-engine.png)

![](/imgs/mvc/nunjucks.png)
...
<section class="card-deck">
  {% for food in foods %}
  <div class="card">
    <div class="card-header text-center font-weight-bold">{{ food.name }}</div>
    <div class="card-body p-0">
      <img src="{{ food.image }}" alt="{{ food.name }}" class="w-100" />
    </div>
    <div class="card-footer text-right">{{ food.price }}</div>
  </div>
  {% endfor %}
</section>
{% endblock %}
...
<img src="/imgs/mvc/preview.png" alt="Preview" width="100%" />
